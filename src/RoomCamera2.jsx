...
Command: npx gltfjsx@6.2.10 ../public/rooms/roomCamera2.glb 
*/
...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/rooms/roomCamera2.glb')
  return (
    <group {...props} dispose={null}>
      <group position={[0, -4, -2]} rotation={[Math.PI, 0, Math.PI]} scale={0.01}>
      ...
      <OrthographicCamera makeDefault={false} far={1000} near={0.1} position={[0.313, 5.208, 5.497]} rotation={[-1.399, -1.047, -1.425]} scale={78.035} />
    </group>
  )
}

useGLTF.preload('/roomCamera2.glb')
