...
Command: npx gltfjsx@6.2.10 ../public/rooms/roomCamera3.glb 
*/
...
export default function Model(props) {
  const { nodes, materials } = useGLTF('/rooms/roomCamera3.glb')
  return (
    <group {...props} dispose={null}>
      <group position={[0, -10, 0]} rotation={[Math.PI, 0, Math.PI]} scale={0.01}>
        <group position={[65, 0, 40]} rotation={[-Math.PI, 0, -Math.PI]}>
          <group scale={[1, 1, 1.5]}>
            ...
            <mesh geometry={nodes.polySurface7_Colors_0.geometry} material={materials['Colors.009']} position={[9.603, 0, 0]} />
          </group>
      ...
      <OrthographicCamera makeDefault={false} far={1000} near={0.1} position={[0.073, 5.088, 4.167]} rotation={[-1.399, -1.047, -1.425]} scale={78.035} />
    </group>
  )
}

useGLTF.preload('/roomCamera3.glb')
